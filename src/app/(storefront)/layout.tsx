        ...
        <div style={{ position: 'fixed', bottom: '24px', right: '24px', zIndex: 1000 }}>
          ...
          >
            ...
            <svg viewBox="0 0 24 24" width="24" height="24" fill="#fff" xmlns="http://www.w3.org/2000/svg">
              <path d="M20.52 3.48A11.91 11.91 0 0012 0C5.37 0 0 5.37 0 12c0 2.12.55 4.14 1.51 5.9L0 24l6.31-1.66A11.89 11.89 0 0012 24c6.63 0 12-5.37 12-12 0-3.19-1.24-6.09-3.48-8.52zM12 22c-1.94 0-3.79-.5-5.4-1.38l-.38-.22-3.75 1 1-3.66-.24-.39A9.99 9.99 0 012 12c0-5.52 4.48-10 10-10s10 4.48 10 10-4.48 10-10 10zm5.5-7.54c-.14-.07-1-.5-1.15-.56-.14-.07-.25-.1-.36.07-.12.16-.44.56-.54.68-.1.12-.2.13-.34.07-.15-.07-1.23-.38-2.34-1.2-.87-.6-1.45-1.34-1.62-1.49-.18-.15-.02-.23.06-.3.07-.07.15-.18.22-.28.07-.1.1-.16.15-.26.05-.1.02-.19-.01-.27-.03-.07-.36-1.11-.51-1.52-.14-.43-.28-.36-.38-.36-.1 0-.22-.01-.33-.01-.12 0-.31.04-.48.21-.17.16-.66.64-.66 1.55 0 .9.66 1.78.75 1.9.09.12 1.28 2.03 3.09 2.85.43.19"/> 
            </svg>
          </a>
        </div>
