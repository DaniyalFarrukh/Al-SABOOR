...
export default function RetailerLoginPage() {
  ...
  return (
    <div className="storefront-container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '60vh', padding: '2rem 1rem' }}>
      <div className="admin-card" style={{ width: '100%', maxWidth: '400px', borderTop: '4px solid var(--primary)' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem' }}>Retailer Portal</h1>
          <p style={{ color: 'var(--muted-foreground)', fontSize: '0.875rem' }}>Sign in to your wholesale B2B account</p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: 'var(--muted-foreground)' }}>
          Not a retailer yet? <Link href="/retailer/signup" style={{ color: 'var(--foreground)', fontWeight: 500 }}>Apply here</Link>
        </div>
      </div>
    </div>
  )
